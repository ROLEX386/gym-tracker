...
const SAMPLE = [
  { id: 1, name: "Rahul Sharma",  phone: "9876543210", plan: "plan1", joinDate: daysAgo(26) },
  { id: 2, name: "Priya Singh",   phone: "9123456789", plan: "plan2", joinDate: daysAgo(88) },
  { id: 3, name: "Amit Kumar",    phone: "9988776655", plan: "plan1", joinDate: daysAgo(10) },
  { id: 4, name: "Sneha Patel",   phone: "9871234560", plan: "plan4", joinDate: daysAgo(300)},
  { id: 5, name: "Vikram Rao",    phone: "9765432100", plan: "plan3", joinDate: daysAgo(182)},
  { id: 6, name: "Anjali Mehta",  phone: "9654321098", plan: "plan2", joinDate: daysAgo(5)  },
];
...
function sendWhatsApp(member, plans) {
  ...
  let msg = days < 0
    ...
    : days <= 7
      ? `Hi ${member.name}! 👋\n\nYour gym membership expires in *${days} day${days===1?"":"s"}*.\n\nRenew to keep going! 💪\n📋 Plan: ${planLabel} — ₹${planPrice}`
...
export default function App() {
  ...
  const [members, setMembers] = useState(() => {
    try { const s = localStorage.getItem("gm_members"); return s ? JSON.parse(s) : SAMPLE; } catch { return SAMPLE; }
  });
  ...
  if (!isAuth) return <LockScreen onUnlock={(token) => { localStorage.setItem("gm_token", token); setIsAuth(true); }} />;
